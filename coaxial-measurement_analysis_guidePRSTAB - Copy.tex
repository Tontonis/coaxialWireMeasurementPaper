...
\title{Bench Top Measurements of the Beam Coupling Impedance Bench Measurements of Asymmetric Structures}
...
\begin{align}
\bar{Z}_{0} = &Z_{0} \\
\bar{Z}_{x} = &\bar{Z}_{1} = Z_{1,1} + Z_{1,-1} \nonumber \\
& + Z_{-1,1} + Z_{-1,-1} = kZ^{dip}_{x}\\
\bar{Z}_{x} = &\bar{Z}_{1} \text{(cos replaced with sin)}= Z_{1,1} - Z_{1,-1} \nonumber \\
& - Z_{-1,1} + Z_{-1,-1} = kZ^{dip}_{y}\\
...
\begin{figure}
\begin{center}
\includegraphics[width=0.45\textwidth]{figures/wire_meas_two_wire.pdf}
\end{center}
